...
//        mapAndroid.put("用户名", "id:userNameEt");
        ...
        mapAndroid.put("爱盈宝", Arrays.asList("xpath://*[@text='爱盈宝']"));
        mapAndroid.put("月进宝记录", Arrays.asList("xpath://*[@text='月进宝']"));
        ...
        mapAndroid.put("立即投资按钮", Arrays.asList("id:productItemBtn"));
        ...
        mapAndroid.put("我的奖励-奖励劵", Arrays.asList("id:myReward_tab_juan"));
        ...
        mapIos.put("doraemon清除本地数据1", Arrays.asList("id:清除本地数据"));
        ...
        mapIos.put("爱盈宝", Arrays.asList("id:爱盈宝"));
        mapIos.put("月进宝记录", Arrays.asList("id:月进宝"));
        ...
        mapIos.put("立即投资按钮", Arrays.asList("id:立即投资"));
        ...
        mapIos.put("查看过期奖励券", Arrays.asList("id:查看过期奖励券"));
        mapIos.put("我的奖励-奖励劵", Arrays.asList("id:奖励券"));
        mapAndroid.put("奖励劵弹窗-知道了按钮", Arrays.asList("id:知道了"));
    }
