...
public class GetFps {
    ...
    public static void main(String[] args) throws InterruptedException, ArrayIndexOutOfBoundsException {
        String result = "com.iqianjin.client";
        System.out.println(fps(result));
        System.out.println(fps.toString());

    }

    public static double[] fps(String packages) {
        String gfxCMD = "adb  shell dumpsys gfxinfo " + packages;
    ...
    public static double[] getFps(String gfxCMD) {
        ...
        result[0] = ffps;
        result[1] = CommandUtil.streamDouble(frameRate * 100);
        return result;
    }
